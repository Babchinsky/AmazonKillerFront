...
function AppliedFiltersComboBox(props: AppliedFiltersComboBoxProps) {
  ...
  return (
    totalFilters > 0 && (
      <div className={`${comboBoxStyles.smallComboBoxContainer} ${appliedFiltersComboBoxStyles.smallComboBoxContainer}`}>
        <div className={`${comboBoxStyles.smallComboBoxTopContainer} ${appliedFiltersComboBoxStyles.smallComboBoxTopContainer}`} onClick={() => setIsFilterOpen(prev => !prev)}>
