...
import './Header.scss';
import { ADMIN_TOKEN, clearAuth } from '../../utils/authToken';
      ...
      <div className="admin-header__content">
        <div className="admin-header__left">
          ...
          <div className="admin-header__logo">
            <img src="/images/logo/logo.svg" alt="Amazon Logo" />
          </div>
        </div>
      </div>
      <div className={`admin-header__menu ${isMenuOpen ? 'admin-header__menu--open' : ''}`}>
        <div className="admin-header__menu-content">
          ...
          <nav className="admin-header__nav">
            ...
            >
              <img src="/images/icons/users.svg" alt="Users" width="32" height="32" />
              Users
            </Link>
            <Link 
              to="/admin/category" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/images/icons/category.svg" alt="Category" width="32" height="32" />
              Category
            </Link>
            <Link 
              to="/admin/products" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/images/icons/products.svg" alt="Products" width="32" height="32" />
              Products
            </Link>
            <Link 
              to="/admin/orders" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/images/icons/orders.svg" alt="Orders" width="32" height="32" />
              Orders
            </Link>
            <Link 
              to="/admin/reviews" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/images/icons/reviews.svg" alt="Reviews" width="32" height="32" />
              Reviews
            </Link>
          </nav>
          <button className="admin-header__logout" onClick={handleLogout}>
            <img src="/images/icons/exit.svg" alt="Log out" width="32" height="32" />
            Log out
          </button>
        </div>
      </div>
